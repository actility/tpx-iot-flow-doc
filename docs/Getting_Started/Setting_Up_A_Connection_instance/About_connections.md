...
| ```configuration/sendMetadata``` (optional) | <ul><li>For backward compatibility with tpdx-dataflow you can set sendMetadata to true to remove ‘DevEUI_uplink’ root node from uplinks.</li><li>Default value in tpx-flow is false.</li></ul> |
